...
\begin{document}
	...
	\end{proof} 	
 	...
 	\begin{prop} 
		...
		\begin{enumerate}
			\item Dado $K$ convexo y $a \geq 0$, $aK$ es convexo.
			\item Dados $K_1, K_2$ conjuntos convexos, entonces $K_1 + K_2$ es convexo.
			\item Dada una familia de conjuntos convexos $\{ K_\alpha \}_\alpha$ se tiene que la intersección $\bigcap_{\alpha} K_\alpha$ es convexa.
		\end{enumerate} 		
 	\end{prop}
