...
\begin{document}
	...
	\marginnote[*0]{
		\begin{center}
			\includegraphics[width=4cm]{hardy.jpeg}\\
	...
	\marginnote[*+7]{
		\begin{center}
			\includegraphics[width=4cm]{littlewood.jpeg}\\
	...
	\begin{proof} Comencemos con un poco de notación.
		...
		\marginnote[*-20]{		
		\begin{center}
			\includegraphics[width=4cm]{vitali.jpg}\\
		...
		Sea $Q_1^{*}$ el cubo con mismo centro que $Q_1$ y con lado de longitud $5\ell_1$. \sidenote[][*-6]{
			\begin{center}
				\includegraphics[width=4cm]{cubo.png}\\
	...
	Con los resultado previos, estamos en condiciones tanto de enunciar como de demostrar este resultado. 	\marginnote{
		\begin{center}
			\includegraphics[width=4cm]{lebesgue.jpeg}\\
	...
	\marginnote[*-16]{
	\begin{center}
		\includegraphics[width=4cm]{chevy.png}\\
